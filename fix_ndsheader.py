...
if not args.read:
	...
	if "dsi" in args.mode:
		...
		srlTwlExtHeader=srlTwlExtHeader._replace(
			MBK_1_5_Settings=		"\x80\x84\x88\x8C\x81\x85\x89\x8D\x91\x95\x99\x9C\x81\x85\x89\x8D\x91\x95\x99\x9D",
			MBK_6_8_Settings_ARM9=	"\xC0\x37\x00\x08\x00\x30\xC0\x07\x00\x30\x00\x00",
			MBK_6_8_Settings_ARM7=	"\x00\x30\x00\x00\x00\x30\x40\x00\xB8\x37\xF8\x07",
			global_MBK_9_Setting=	"\x00\x00\x00\xFF",
